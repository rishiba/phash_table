...
ClientOpsArguments::~ClientOpsArguments() throw() {
}


void ClientOpsArguments::__set_op_type(const int16_t val) {
  this->op_type = val;
}

void ClientOpsArguments::__set_key(const std::string& val) {
  this->key = val;
}

void ClientOpsArguments::__set_value(const std::string& val) {
  this->value = val;
}

uint32_t ClientOpsArguments::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t ClientOpsArguments::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("ClientOpsArguments");
...
ClientOpsArguments::ClientOpsArguments(const ClientOpsArguments& other0) {
  op_type = other0.op_type;
  key = other0.key;
  value = other0.value;
  __isset = other0.__isset;
}
ClientOpsArguments& ClientOpsArguments::operator=(const ClientOpsArguments& other1) {
...
void ClientOpsArguments::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "ClientOpsArguments(";
...
SlaveOpsArguments::~SlaveOpsArguments() throw() {
}


void SlaveOpsArguments::__set_seq_num_prefix(const int64_t val) {
  this->seq_num_prefix = val;
}

void SlaveOpsArguments::__set_seq_number(const int64_t val) {
  this->seq_number = val;
}

void SlaveOpsArguments::__set_client_number(const int32_t val) {
  this->client_number = val;
}

void SlaveOpsArguments::__set_op_type(const int16_t val) {
  this->op_type = val;
}

void SlaveOpsArguments::__set_key(const std::string& val) {
  this->key = val;
}

void SlaveOpsArguments::__set_value(const std::string& val) {
  this->value = val;
}

uint32_t SlaveOpsArguments::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t SlaveOpsArguments::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("SlaveOpsArguments");
...
SlaveOpsArguments::SlaveOpsArguments(const SlaveOpsArguments& other6) {
...
SlaveOpsArguments& SlaveOpsArguments::operator=(const SlaveOpsArguments& other7) {
...
void SlaveOpsArguments::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "SlaveOpsArguments(";
